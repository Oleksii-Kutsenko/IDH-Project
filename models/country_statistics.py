...
class CountryStatistics(Base):
    ...
    time_id = Column(Integer, ForeignKey("time_dimension.time_id"))
    ...
    # military_spending_id = Column(Integer, ForeignKey("military_spending_dimension.military_spending_id"))
