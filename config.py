...
if int(os.getenv("DEBUG")):
    DATABASE_URI = f"mssql+pyodbc://{os.getenv('MSSQL_DEV_USER')}:{os.getenv('MSSQL_SA_PASSWORD')}@{os.getenv('MSSQL_DEV_HOST')}/{os.getenv('MSSQL_DEV_DB')}?driver=ODBC+Driver+17+for+SQL+Server"
else:
    DATABASE_URI = (
